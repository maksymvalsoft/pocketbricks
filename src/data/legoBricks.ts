...
export const BRICK_CATALOG: BrickType[] = [
  ...
  { id: 'plate_1x3', name: 'Plate 1\u00d73', partNumber: '3623', widthStuds: 1, depthStuds: 3, heightPlates: 1, category: 'plate' },
  { id: 'plate_1x4', name: 'Plate 1\u00d74', partNumber: '3710', widthStuds: 1, depthStuds: 4, heightPlates: 1, category: 'plate' },
  { id: 'plate_1x6', name: 'Plate 1\u00d76', partNumber: '3666', widthStuds: 1, depthStuds: 6, heightPlates: 1, category: 'plate' },
  { id: 'plate_2x2', name: 'Plate 2\u00d72', partNumber: '3022', widthStuds: 2, depthStuds: 2, heightPlates: 1, category: 'plate' },
  { id: 'plate_2x3', name: 'Plate 2\u00d73', partNumber: '3021', widthStuds: 2, depthStuds: 3, heightPlates: 1, category: 'plate' },
